...
Widget _privacyContent(BuildContext context) {
  ...
  return Column(
    ...
    children: [
      ...
      Text(
        'Última actualización de este texto: versión AIPROD2.4.0_R3_IN de ${AppConstants.appName}. No sustituye el aviso de privacidad integral que corresponda a cada instalación.',

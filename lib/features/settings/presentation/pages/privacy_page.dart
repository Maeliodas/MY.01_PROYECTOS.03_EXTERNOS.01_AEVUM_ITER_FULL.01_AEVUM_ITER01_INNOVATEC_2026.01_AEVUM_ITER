  ...
  return Column(
    ...
    children: [
      ...
      const _Section(
        ...
        'Para solicitudes de acceso, rectificación, cancelación u oposición deberás utilizar los mecanismos que correspondan al aviso de privacidad vigente de la instancia responsable de la instalación.',
      ),
      const SizedBox(height: 4),
      Text(
        'Este texto describe el funcionamiento de ${AppConstants.appName} como prototipo y no sustituye el aviso de privacidad integral que corresponda a cada instalación.',

        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Column(children: [
              ...
              const Text('Selecciona un avatar predeterminado o elige otra imagen tuya.', textAlign: TextAlign.center, style: TextStyle(fontSize: 16, height: 1.35, color: AppColors.textSecondary)),

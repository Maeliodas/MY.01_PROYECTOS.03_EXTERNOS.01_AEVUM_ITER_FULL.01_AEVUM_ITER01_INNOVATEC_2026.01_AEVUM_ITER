    ...
    return Scaffold(
      body: SafeArea(
        child: ListView(padding: const EdgeInsets.fromLTRB(22, 16, 22, 30), children: [
          Row(children: [const Text(AppConstants.appName, style: TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: Color(0xFF0262FC))), const Spacer(), IconButton(onPressed: () => context.push('/settings'), icon: const Icon(Icons.settings_outlined))]),
          ...
          _Menu(icon: Icons.settings_outlined, color: const Color(0xFF0262FC), title: 'Configuración', subtitle: 'Preferencias y privacidad', onTap: () => context.push('/settings')),
          _Menu(

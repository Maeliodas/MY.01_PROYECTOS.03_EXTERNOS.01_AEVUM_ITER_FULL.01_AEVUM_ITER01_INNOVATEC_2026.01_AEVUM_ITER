    ...
    return Scaffold(
      body: SafeArea(
        child: ListView(padding: const EdgeInsets.fromLTRB(22, 16, 22, 30), children: [
          ...
          Row(children: [Expanded(child: _Stat(icon: Icons.check_circle_outline_rounded, title: 'TESTS\nCOMPLETADOS', value: historyCount.toString(), color: const Color(0xFF0262FC))), const SizedBox(width: 14), Expanded(child: _Stat(icon: Icons.school_outlined, title: 'ESCUELA', value: profile.school, color: const Color(0xFF6C2BC8), small: true))]),
